  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="text-center md:text-lg lg:text-lg text-white/60 mt-4 max-w-md mx-auto">See how I transformed concepts into engaging experiences</p>
